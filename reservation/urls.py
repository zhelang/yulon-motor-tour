...
urlpatterns = [
    ...
    re_path(r'^(?P<customer_pk>[0-9]+)/(?P<service_pk>[0-9]+)/(?P<timeslot_pk>[0-9]+)/info/$',
            views.Info.as_view(),
    ...
    re_path(r'^site_admin/order/cancelreservation/(?P<order_pk>[0-9]+)/$',
            views.admin_cancel_reservation,
            name='admin-reservation-cancel'),
    re_path(r'^site_admin/order/ticket/cancelreservation/(?P<ticket_pk>[0-9]+)/$',
            views.admin_cancel_ticket_reservation,
            name='admin-ticket-reservation-cancel'),
    re_path(r'^sendvalidation_email/(?P<order_pk>[0-9]+)/$',
            views.send_validation_email,
            name='reservation-send-email'),
    ...
    re_path(r'^confirm_reservation/(?P<validation_key>[\w]+)/$',
            views.confirm_reservation,
            name='reservation-confirm-reservation'),
