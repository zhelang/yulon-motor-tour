...
urlpatterns = [
    ...
    re_path(r'^password_reset/done/$',
            ...
            name='front_password_reset_done'),
    re_path(r'^reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',
            views.PasswordResetConfirm.as_view(),
            name='front_password_reset_confirm'),
    re_path(r'^reset/done/$',
            PasswordResetCompleteView.as_view(template_name='password_set_complete.html'),
            name='front_password_reset_complete'),
    ...
    re_path(r'^site_admin/password/reset/$',
            views.AdminPasswordReset.as_view(),
            name='password_reset'),
    re_path(r'^site_admin/password_reset/done/$',
            PasswordResetDoneView.as_view(template_name='admin_site/password_reset_done.html'),
            name='password_reset_done'),
    re_path(r'^site_admin/reset/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$',
            views.AdminPasswordResetConfirm.as_view(),
            name='password_reset_confirm'),
    re_path(r'^site_admin/reset/done/$',
            PasswordResetCompleteView.as_view(template_name='admin_site/password_set_complete.html'),
    ...
    re_path(r'^site_admin/info/faq/(?P<pk>[0-9]+)/$',
            views.AdminFAQEdit.as_view(),
            name='admin-faq-edit'),
    re_path(r'^site_admin/info/faq/(?P<pk>[0-9]+)/delete/$',
            views.adminFAQDelete,
    ...
    re_path(r'^site_admin/service/course/new/$',
            views.AdminServiceCreate.as_view(),
            name='admin-service-create'),
    re_path(r'^site_admin/service/course/(?P<pk>[0-9]+)/$',
            views.AdminServiceEdit.as_view(),
            name='admin-service-edit'),
    re_path(r'^site_admin/service/course/(?P<pk>[0-9]+)/delete/$',
            views.adminServiceDelete,
            name='admin-service-delete'),
    re_path(r'^site_admin/service/customer/$', views.AdminCustomer.as_view(), name='admin-customer'),
    re_path(r'^site_admin/service/customer/new/$',
            views.AdminCustomerCreate.as_view(),
            name='admin-customer-create'),
    re_path(r'^site_admin/service/customer/(?P<pk>[0-9]+)/$',
            views.AdminCustomerEdit.as_view(),
            name='admin-customer-edit'),
    re_path(r'^site_admin/service/customer/(?P<pk>[0-9]+)/delete/$',
            views.adminCustomerDelete,
    ...
    re_path(r'^site_admin/calendar/time_slot/(?P<date>[0-9]{4}-?[0-9]{2}-?[0-9]{2})/$',
            views.AdminTimeSlot.as_view(),
            name='admin-timeslot-date'),
    re_path(r'^site_admin/calendar/time_slot/(?P<date>[0-9]{4}-?[0-9]{2}-?[0-9]{2})/edit/(?P<pk>[0-9]+)/$',
            views.AdminTimeSlotEdit.as_view(),
            name='admin-timeslot-date-edit'),
    re_path(r'^site_admin/calendar/time_slot/(?P<date>[0-9]{4}-?[0-9]{2}-?[0-9]{2})/delete/(?P<pk>[0-9]+)/$',
            views.adminTimeSlotDelete,
            name='admin-timeslot-date-delete'),
    ...
    re_path(r'^site_admin/comment/(?P<pk>[0-9]+)/disapprove/$',
            views.adminCommentDisapprove,
            name='admin-comment-disapprove'),
    ...
    re_path(r'^googlee431d29ab682695b\.html$',
            lambda r: HttpResponse("google-site-verification: googlee431d29ab682695b.html", content_type="text/plain")),
